...
(judgment-holds (replace-phis
                 ...
                 (empty lbl-orig lbl-new)
                 ((reg-test = phi i32 (3 lbl-new) (2 lbl-test)) (ret i32 labeltest))))
...
(judgment-holds (replace-phis
                 ...
                 (empty lbl-orig lbl-new)
                 ((ret i32 labeltry) ((reg-test = phi i32 (3 lbl-test) (2 lbl-new)) (ret i32 labeltest)))))
(judgment-holds (replace-phis
                 ((rv = phi i32 [1 entry] [rfour two]) ((ri = phi i32 [1 entry] [rfive two]) ((rtwo = icmp sle i32 ri rd) (br i1 rtwo label two label three))))
                 ((empty entry 17) two 2)
                 ((rv = phi i32 (1 17) (rfour 2)) ((ri = phi i32 (1 17) (rfive 2)) ((rtwo = icmp sle i32 ri rd) (br i1 rtwo label two label three))))))
...
(judgment-holds (replace-all-phis
   ...
   lbl-test
   ((ret i32 labeltry)
    ((reg-test = phi i32 (3 lbl-test) (2 lbl-new)) (ret i32 labeltest)))
   empty)))
(judgment-holds (replace-all-phis (label lbl-test ((ret i32 labeltry) ((reg-test = phi i32 [3 lbl-test] [2 lbl-orig]) (ret i32 labeltest)))
   ...
   (label
    lbl-orig
    ((ret i32 kk)
     ((reg-test = phi i32 (3 lbl-new) (2 lbl-kk)) (ret i32 lbl-orig)))
    empty))))
(judgment-holds (replace-all-phis
                 (label entry (br label one) (label one ((rv = phi i32 [1 entry] [rfour two]) ((ri = phi i32 [1 entry] [rfive two]) ((rtwo = icmp sle i32 ri rd) (br i1 rtwo label two label three)))) (label two ((rfour = mul nsw i32 rv 2) ((rfive = add nsw i32 ri 1)(br label one))) (label three (ret i32 rv) empty))))
                 ((empty entry 17) two 2)
                 (label
   entry
   (br label one)
   (label
    one
    ((rv = phi i32 (1 17) (rfour 2))
     ((ri = phi i32 (1 17) (rfive 2))
...
(judgment-holds (-->pass1a 0 (label testlbl ((g = add nsw i32 g 1) ((g = add nsw i32 g 1) (ret i32 g))) empty)
   ...
   (label 0 ((g = add nsw i32 g 1) (br label 1)) (label 1 (ret i32 g) empty)))
                          ((empty 0 1) testlbl 1)))
(judgment-holds (-->pass1a 0 (label entry ((g = add nsw i32 g 1) (br label one))
...
(judgment-holds (-->pass1a 0
   ...
   (label
    one
    ((rv = phi i32 (1 entry) (rfour two)) (br label 1))
    (label
     1
     ((ri = phi i32 (1 entry) (rfive two)) (br label 2))
     (label
      2
...
(judgment-holds (-->pass1
   (label testlbl ((g = add nsw i32 g 1) ((g = add nsw i32 g 1) (ret i32 g))) empty)
   (label testlbl ((g = add nsw i32 g 1) (br label 0))
   (label 0 ((g = add nsw i32 g 1) (br label 1))
   (label 1 (ret i32 g) empty)))))

(judgment-holds (-->pass1
   (label entry ((g = add nsw i32 g 1) (br label one))
   (label three ((g = add nsw i32 g 1) ((g = add nsw i32 g 1) (ret i32 g))) empty))

   (label entry ((g = add nsw i32 g 1) (br label 0))
   (label 0 (br label one)
   (label three ((g = add nsw i32 g 1) (br label 2))
   (label 2 ((g = add nsw i32 g 1) (br label 3))
   (label 3 (ret i32 g) empty)))))
))

(judgment-holds (-->pass1a 1 
   ...
   (label
   two
   ((rfour = mul nsw i32 rv 2) (br label 1))
   (label
    1
    ((rfive = add nsw i32 ri 1) (br label 2))
    (label 2 (br label one) (label three (ret i32 rv) empty))))
   ((empty 1 2) two 2) ))
...
(judgment-holds (eval
     (label entry (br label one)
     (label one ((rv = phi i32 [1 entry] [rfour 6]) ((ri = phi i32 [1 entry] [rfive 6]) (br label 2)))
     (label 2 ((rtwo = icmp sle i32 ri rd) (br label 3))
     (label 3 (br i1 rtwo label two label three)
     (label two ((rfour = mul nsw i32 rv 2) (br label 5))
     (label 5 ((rfive = add nsw i32 ri 1) (br label 6))
...
(judgment-holds (eval
     (label entry (br label one)
     (label one ((rv = phi i32 [1 entry] [rfour two]) ((ri = phi i32 [1 entry] [rfive two]) ((rtwo = icmp sle i32 ri rd) (br i1 rtwo label two label three))))
